...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="<?php echo base_url() ?>assets/backend_assets/vendor/datatables-new/datatables.css" rel="stylesheet">
...
<body>
                        ...
                        <li>
                          <a href="#"><i class="fa fa-flag fa-fw"></i> Generate Laporan<span class="fa arrow"></span></a></a>
                            <ul class="nav nav-second-level">
                              ...
                              <li>
                                <a href="<?php echo base_url('admin_system/laporan_bulanan') ?>"><i class="fa fa-flag-checkered fa-fw"></i> Laporan Bulanan</a>
                              </li>
                            </ul>
                        </li>
                        <li>
    ...
    <script src="<?php echo base_url() ?>assets/backend_assets/vendor/datatables-new/datatables.js"></script>
    <!-- Validation Plugin -->
    <script src="<?php echo base_url() ?>assets/backend_assets/vendor/jquery-validation/jquery.validate.js"></script>
    <script src="<?php echo base_url() ?>assets/backend_assets/vendor/chartjs/chart.umd.js"></script>


    <!-- WARNING: DATA TABLES SCRIPT -->
    <script>
      $(document).ready(function() {
        let property =  { responsive: true };

        <?php if (current_url() == base_url('admin_system/laporan_pinjam') || current_url() == base_url('admin_system/laporan_bulanan')) { ?>
          property = {
              responsive: true,
              dom: 'Bfrtip',
              buttons: [
        ...
        <?php if (current_url() == base_url('admin_system/laporan_bulanan')) { ?>
        $.fn.dataTable.ext.search.push(
            function( settings, data, dataIndex ) {
              let d = new Date( data[4] );
              let tahun = $('#tahun').val();
              let bulan = $('#bulan').val();

              if (tahun == d.getFullYear() && bulan == d.getMonth()+1) return true;
              return false;
            }
        );
        let tableMonth = $('#tableMonth').DataTable(property);
        ...
        $('#dataTables-example').DataTable(property);
      });
    </script>
