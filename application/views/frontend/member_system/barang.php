                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <form action="<?php echo base_url('member_system/barang_pinjam') ?>" method="post">
										          ...
										          <button class="btn btn-danger btn-xs btn-delete" type="submit" data-original-title="delete" data-placement="top" data-toggle="tooltip" <?= $d1->stock < 1 ? 'disabled' : '' ?>><i class="fa fa-book"></i> Pinjam</button>
								 	          </form>
                          </td>
                        </tr>
                        <?php } ?>
