...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Laboratorium IPA</a>
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <strong>Peminjaman Alat Lab SMP Negeri 2 Baki</strong>
            </h1>
            <hr>
          </div>
          <div class="col-lg-8 mx-auto">
            <p class="text-faded">Aplikasi Untuk Peminjaman Alat Lab SMP Negeri 2 Baki</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <h2 class="section-heading text-white">Kami menyediakan Peminjaman Alat Lab SMP Negeri 2 Baki</h2>
            <hr class="light my-4">
            <p class="text-faded mb-4">Kami menyediakan beberapa Alat Lab Yang Di Sediakan Oleh Sekolah</p>
